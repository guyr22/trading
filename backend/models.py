...
class User(Base):
    ...
    # Opt-in for the weekly portfolio digest email (off by default).
    digest_opt_in: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False, server_default="false")
